    ...
    return (
      <span
        className={cn(
          ...
          ours ? "bg-[#0e3621] text-white shadow-xs" : "bg-slate-100 text-slate-600",
        )}
      >
  ...
  return (
    <span
      className={cn(
        ...
        ours ? "text-[#0e3621] font-semibold" : "text-slate-600",
      )}
    >
                ...
                {columns.map((col) => (
                  <th
                    ...
                    className={cn(
                      ...
                      col.ours ? "bg-[#0e3621] text-white" : "bg-surface text-navy",
                    )}
                  >
                    {col.short}
                    {col.ours ? (
                      <span className="mt-0.5 block text-[8px] font-medium uppercase tracking-wider text-[#b49339]">
                        Rec.
                      </span>
                    ) : null}
                  </th>
                ...
                {columns.map((col) => (
                  <th
                    ...
                    className={cn(
                      ...
                      col.ours
                        ? "bg-[#0e3621] text-white"
                        : "bg-surface text-navy",
                    )}
                  >
                    {col.label}
                    {col.ours ? (
                      <span className="mt-1 block text-[10px] font-medium uppercase tracking-wider text-[#b49339]">
                        Recommended
                      </span>
                    ) : null}
                  </th>
