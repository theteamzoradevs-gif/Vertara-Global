        ...
        >
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mb-6 max-w-3xl md:mb-8">
              <p className="mb-2 text-xs font-semibold uppercase tracking-[0.18em] text-[#b49339]">
                How it unfolds
              </p>
              ...
              <p className="mt-3 text-sm text-muted md:text-base">
                From defining the opportunity to building and launching an India GCC, we guide every critical stage.
              </p>
            </div>
                ...
                {steps.map((s, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p
                        className={cn(
                          "mt-2 text-xs font-bold leading-snug lg:text-sm transition-colors duration-200",
                          isActive ? "text-navy font-extrabold" : "text-slate",
                        )}
                      >
                        {s.title}
                      </p>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#b49339]">
